...
public class BaseMusicActivity extends AppCompatActivity implements ServiceConnection, MusicStateListener {
...
//                    baseMusicActivity.mPlayPauseProgressButton.getPlayPauseButton().updateState();
                    ...
                    Toast.makeText(baseMusicActivity, errorMsg, Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
